#ifndef _HOLISTIC_MOTION_HOLISTIC_MOTION_SE3_MAP_H_
#define _HOLISTIC_MOTION_HOLISTIC_MOTION_SE3_MAP_H_

#include "holistic_motion/manif/impl/se3/SE3.h"
...
struct traits<Eigen::Map<SE3<_Scalar>, 0>> : public traits<SE3<_Scalar>> {
...
class Map<holistic_motion::robotics::SE3<_Scalar>, 0>
    : public holistic_motion::robotics::SE3Base<Map<holistic_motion::robotics::SE3<_Scalar>, 0>> {
    using Base = holistic_motion::robotics::SE3Base<Map<holistic_motion::robotics::SE3<_Scalar>, 0>>;
...
public:
    ...
    HOLISTIC_MOTION_GROUP_MAP_ASSIGN_OP(SE3)
 ...
 */
template <class _Scalar>
class Map<const holistic_motion::robotics::SE3<_Scalar>, 0>
    : public holistic_motion::robotics::SE3Base<
              Map<const holistic_motion::robotics::SE3<_Scalar>, 0>> {
    using Base =
            holistic_motion::robotics::SE3Base<Map<const holistic_motion::robotics::SE3<_Scalar>, 0>>;
...
#endif /* _HOLISTIC_MOTION_HOLISTIC_MOTION_SE3_MAP_H_ */
