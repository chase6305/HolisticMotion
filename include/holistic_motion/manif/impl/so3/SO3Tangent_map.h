#ifndef _HOLISTIC_MOTION_HOLISTIC_MOTION_SO3TANGENT_MAP_H_
#define _HOLISTIC_MOTION_HOLISTIC_MOTION_SO3TANGENT_MAP_H_

#include "holistic_motion/manif/impl/so3/SO3Tangent.h"
...
/**
 * @brief Specialization of Map for holistic_motion::robotics::SO3Tangent
 */
template <class _Scalar>
class Map<holistic_motion::robotics::SO3Tangent<_Scalar>, 0>
    : public holistic_motion::robotics::SO3TangentBase<
              Map<holistic_motion::robotics::SO3Tangent<_Scalar>, 0>> {
    using Base = holistic_motion::robotics::SO3TangentBase<
            Map<holistic_motion::robotics::SO3Tangent<_Scalar>, 0>>;
...
public:
    ...
    HOLISTIC_MOTION_TANGENT_MAP_ASSIGN_OP(SO3Tangent)
...
/**
 * @brief Specialization of Map for const holistic_motion::robotics::SO3Tangent
 */
template <class _Scalar>
class Map<const holistic_motion::robotics::SO3Tangent<_Scalar>, 0>
    : public holistic_motion::robotics::SO3TangentBase<
              Map<const holistic_motion::robotics::SO3Tangent<_Scalar>, 0>> {
    using Base = holistic_motion::robotics::SO3TangentBase<
            Map<const holistic_motion::robotics::SO3Tangent<_Scalar>, 0>>;
...
#endif /* _HOLISTIC_MOTION_HOLISTIC_MOTION_SO3TANGENT_MAP_H_ */
