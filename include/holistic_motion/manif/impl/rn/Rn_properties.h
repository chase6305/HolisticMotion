#ifndef _HOLISTIC_MOTION_HOLISTIC_MOTION_RN_PROPERTIES_H_
#define _HOLISTIC_MOTION_HOLISTIC_MOTION_RN_PROPERTIES_H_
...
struct LieGroupProperties<RnBase<_Derived>> {
    ...
    static constexpr int DoF =
            traits<_Derived>::Dim;  /// @brief Degrees of freedom
};
...
#endif  // _HOLISTIC_MOTION_HOLISTIC_MOTION_RN_PROPERTIES_H_
