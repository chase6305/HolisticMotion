#ifndef _HOLISTIC_MOTION_HOLISTIC_MOTION_CONSTANTS_H_
#define _HOLISTIC_MOTION_HOLISTIC_MOTION_CONSTANTS_H_

#include <cmath>
#include <limits>

#define HOLISTIC_MOTION_PI 3.141592653589793238462643383279502884
#define HOLISTIC_MOTION_PI_2 1.570796326794896619231321691639751442
#define HOLISTIC_MOTION_PI_4 0.785398163397448309615660845819875721
...
struct Constants {
    static constexpr _Scalar eps =
            std::numeric_limits<_Scalar>::epsilon() * _Scalar(100);
    static constexpr _Scalar eps_sqrt = internal::csqrt(eps);

    static constexpr _Scalar to_rad = _Scalar(HOLISTIC_MOTION_PI / 180.0);
    static constexpr _Scalar to_deg = _Scalar(180.0 / HOLISTIC_MOTION_PI);
};
...
#endif /* _HOLISTIC_MOTION_HOLISTIC_MOTION_CONSTANTS_H_ */
