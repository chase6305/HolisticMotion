...
echo "  ./scripts/run.sh python3 examples/python/planning/classic_plan_and_retime.py"
...
echo "  ./scripts/run-python-toolkit.sh python3 examples/python/retargeting/classic_torso_first.py --help"
